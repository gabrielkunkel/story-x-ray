...
```bash
node "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/bin/gsd-tools.cjs" config-ensure-section
...
AskUserQuestion([
  {
    ...
    multiSelect: false,
    options: [
      { label: "Quality", description: "Sonnet everywhere except verification" },
      { label: "Balanced (Recommended)", description: "Sonnet for planning, Sonnet for research/execution/verification" },

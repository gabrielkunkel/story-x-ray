...
const MODEL_PROFILES = {
  'gsd-planner': { quality: 'sonnet', balanced: 'sonnet', budget: 'sonnet', adaptive: 'sonnet' },
  'gsd-roadmapper': { quality: 'sonnet', balanced: 'sonnet', budget: 'sonnet', adaptive: 'sonnet' },
  'gsd-executor': { quality: 'sonnet', balanced: 'sonnet', budget: 'sonnet', adaptive: 'sonnet' },
  'gsd-phase-researcher': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku', adaptive: 'sonnet' },
  'gsd-project-researcher': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku', adaptive: 'sonnet' },
  'gsd-research-synthesizer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku', adaptive: 'haiku' },
  'gsd-debugger': { quality: 'sonnet', balanced: 'sonnet', budget: 'sonnet', adaptive: 'sonnet' },
  ...
  'gsd-ui-researcher': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku', adaptive: 'sonnet' },
  ...
  'gsd-doc-writer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku', adaptive: 'sonnet' },

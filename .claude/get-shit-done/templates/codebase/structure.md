...
- Usage: Reference from command with `@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

...
```bash
cp "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/USER-PROFILE.md" "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/USER-PROFILE.backup.md"
```

...
<required_reading>
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/references/ai-frameworks.md
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/agents/gsd-eval-planner.md for instructions.

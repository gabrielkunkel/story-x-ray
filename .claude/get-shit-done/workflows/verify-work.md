...
Read and follow `/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```

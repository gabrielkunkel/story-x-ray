...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude
                  → checks /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done
                  → writes to /Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/hooks/
...
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

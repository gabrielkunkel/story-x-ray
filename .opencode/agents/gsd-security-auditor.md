...
**Verification depth scales with `asvs_level`** (see @/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):

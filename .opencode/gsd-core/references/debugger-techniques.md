...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode
                  → checks /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core
                  → writes to /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/hooks/

...
- **Global scope**: `/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/notes/`)
...
2. Glob `/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/notes/` — works in any directory

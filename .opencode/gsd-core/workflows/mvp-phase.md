...
<required_reading>
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/user-story-template.md
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/spidr-splitting.md
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/spidr-splitting.md`. Briefly:

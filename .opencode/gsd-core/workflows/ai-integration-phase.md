...
<required_reading>
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/ai-frameworks.md
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-eval-planner.md for instructions.

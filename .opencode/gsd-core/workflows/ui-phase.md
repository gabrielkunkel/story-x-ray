...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)

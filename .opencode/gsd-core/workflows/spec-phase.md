...
ones). Reference: @/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/gabrielkunkel/WebstormProjects/story-x-ray/.opencode/gsd-core/templates/spec.md.
